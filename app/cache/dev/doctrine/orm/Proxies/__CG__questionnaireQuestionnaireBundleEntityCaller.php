 ...
 */
class Caller extends \questionnaire\QuestionnaireBundle\Entity\Caller implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'adress', 'phone', 'mail');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Caller $proxy) {
