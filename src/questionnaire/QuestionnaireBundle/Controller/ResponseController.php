...
use questionnaire\QuestionnaireBundle\Entity\Response;
use questionnaire\QuestionnaireBundle\Form\ResponseType;
...
class ResponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('questionnaireQuestionnaireBundle:Response')->findAll();

        return $this->render('questionnaireQuestionnaireBundle:Response:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('questionnaireQuestionnaireBundle:Response:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Response $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Repondre','attr'=>array('class'=>'btn btn-warning')));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('questionnaireQuestionnaireBundle:Response')->find($id);
        ...
        return $this->render('questionnaireQuestionnaireBundle:Response:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('questionnaireQuestionnaireBundle:Response:edit.html.twig', array(
            'entity'      => $entity,
